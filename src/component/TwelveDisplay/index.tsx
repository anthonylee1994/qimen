...
export const TwelveDisplay = React.memo<Props>(({renderer, itemsMap, size}) => {
    return (
        <Flex position="absolute" w={size * 1.2} height={size * 1.2}>
            ...
            <Vertical size={size} top={size * 0.1} left={0}>
                {renderer ? renderer(itemsMap.辰) : itemsMap.辰}
            </Vertical>
            <Horizontal size={size} top={0} left={size * 0.1}>
            ...
            <Horizontal size={size} top={0} right={size * 0.1}>
                {renderer ? renderer(itemsMap.未) : itemsMap.未}
            </Horizontal>
            <Vertical size={size} top={size * 0.1} right={0}>
            ...
            <Vertical size={size} bottom={size * 0.1} right={0}>
                {renderer ? renderer(itemsMap.戌) : itemsMap.戌}
            </Vertical>
            <Horizontal size={size} bottom={0} right={size * 0.1}>
